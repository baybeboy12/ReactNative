    ...
    <View style={styles.container}>
      ...
      >
        <FlatList
          ...
          renderItem={({ item }) => (
            <Pressable
              onPress={() =>item.status==="Accepting Orders" ? navigation.navigate("Drinks", { shop: item })
              : alert("Cua hang dang dong cua")}
            >
              <View
                style={{
                  width: "100%",
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      source={item.status === "Accepting Orders" ? require("./image/IconCheck.PNG")
                    : require("./image/IconLock.PNG") }
                    ...
                    <Text
                      style={{
                        width: 160,
                        height: 22,
                        color: item.status==="Accepting Orders"?"green":"red",
                        marginLeft: 8,
                      }}
